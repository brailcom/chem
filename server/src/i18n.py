...
#
#
# 2007-11-07 made part of brailchem, based on CVS version 1.24 from
# http://cvs.freebsoft.org/repository/lcg/lib/lcg/
#
# small changes made by Beda Kosata <kosatab@vscht.cz>
    ...
    def _gettext_instance(self, domain, origin):
        ...
        for path in paths:
            if gettext.find( domain, localedir=path, languages=[self._lang]):
                return gettext.translation( domain, localedir=path, languages=[self._lang])
